...
{
    /// <summary>How the Trapline wheel is opened.</summary>
    internal enum WheelMode
    {
        /// <summary>Take over the vanilla weapon-wheel control. Holding it opens Trapline instead.</summary>
        Replace,

        /// <summary>Leave the vanilla wheel alone; open Trapline from its own key.</summary>
        Separate
    }
    ...
    /// <summary>
    /// Typed view over Trapline.ini. Every value has a working code default, so the mod
