    ...
    internal sealed class GangRegistry
    {
        ...
        private void ResolveGroups()
        {
            foreach (var g in _ordered)
            {
                ...
                {
                    g.RelationshipGroup = "TRAPLINE_" + g.Id.ToUpperInvariant();
                }
        ...
        /// <summary>
        /// Built-in gangs. Zone codes are GET_NAME_OF_ZONE values and are a best-effort
        /// starting map -- an unrecognised code simply never matches, costing that gang some
        /// turf. Use Turf > "Log this zone" in game and correct gangs.json.
        /// </summary>
