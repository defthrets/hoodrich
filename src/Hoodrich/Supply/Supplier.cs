...
namespace Hoodrich.Supply
{
    ...
    internal sealed class SupplierDef
    {
        ...
        /// <summary>
        /// Products this contact can move. An EMPTY list means "everything in the catalogue" --
        /// that is how the docks work, and it means adding a new product to drugs.json
        /// automatically shows up there without editing this file.
        /// </summary>
        public readonly List<string> Drugs = new List<string>();

        /// <summary>
        /// Gang this contact belongs to, or empty for an independent. A gang contact will not
        /// deal with you at all if they are at war with your crew, and cuts you a better price
        /// the better you stand with them.
        /// </summary>
        public string GangId = "";

        public bool IsGangContact => !string.IsNullOrEmpty(GangId);
        ...
        {
            if (Drugs.Count == 0) return true; // empty list == full catalogue
