...
// C:\projects\parkview\src\Parkview\Core\Log.cs. Change it there; the next build overwrites this.
using System;
...
namespace Hoodrich.Parkview.Core
{
    ...
    /// <summary>
    /// File logger for scripts\Parkview\Parkview.log.
    ///
    ...
    /// <summary>What this thing is called, in the one place anything is allowed to ask.</summary>
    internal static class Build
    {
        public const string Version = "0.1.0";
        public const string Name = "Parkview";
